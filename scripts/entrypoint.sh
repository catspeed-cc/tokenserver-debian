...
/usr/bin/git clone --bare https://github.com/YunzheZJU/youtube-po-token-generator.git youtube-po-token-generator

# git the catspeed projects (just do it :3c)
/usr/bin/git clone --bare https://github.com/catspeed-cc/invidious.git invidious
/usr/bin/git clone --bare https://github.com/catspeed-cc/tokenserver-debian.git tokenserver-debian
